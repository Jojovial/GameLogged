...
Revision ID: 7a1be24ad306
Revises: 
Create Date: 2023-07-13 15:41:26.368845
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['game_id'], ['flask_schema.games.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['flask_schema.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='flask_schema'
    )
    ...
    sa.ForeignKeyConstraint(['comment_id'], ['flask_schema.comments.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['flask_schema.users.id'], ),
    ...
    sa.ForeignKeyConstraint(['review_id'], ['flask_schema.reviews.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['flask_schema.users.id'], ),
...
def downgrade():
    ...
    op.drop_table('statuses', schema='flask_schema')
    op.drop_table('memory_cards', schema='flask_schema')
    op.drop_table('reviews', schema='flask_schema')
    op.drop_table('entries', schema='flask_schema')
    op.drop_table('comments', schema='flask_schema')
    op.drop_table('users', schema='flask_schema')
    op.drop_table('games', schema='flask_schema')
    # ### end Alembic commands ###
