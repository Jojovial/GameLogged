...
Revision ID: 6c930bc570fc
Revises:
Create Date: 2023-07-17 14:20:27.912803
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    if environment == 'production' and SCHEMA:
        op.drop_table('user_review', schema=SCHEMA)
    op.drop_table('statuses')
    op.drop_table('reviews')
    op.drop_table('memory_cards')
    if environment == 'production' and SCHEMA:
        op.drop_table('user_entry', schema=SCHEMA)
        op.drop_table('user_comment', schema=SCHEMA)
